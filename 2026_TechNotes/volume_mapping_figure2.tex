\begin{tikzpicture}[scale=1.5]
    ...
    \coordinate (xJ11) at ($(xc1) + (-100:0.8)$);
    ...
    \fill (xJ1) circle (2pt) node[left] {$\tilde{x}(1)$};
    \fill (xJ0) circle (2pt) node[above right] {$\tilde{x}(0)$};
    \fill (x11) circle (2pt) node[below left] {$x'(1)$};
    \fill (xJ11) circle (2pt) node[above right] {$\tilde{x}'(1)$};
    \fill (xJ01) circle (2pt) node[above left] {$\tilde{x}'(0)$};
    
    % Draw curved arrows
    \draw[-{Stealth[length=3mm]}, thick, green!80!black] (xJ0) to[out=170, in=10] node[midway, below] {$\psi_{\theta}$} (xJ1);
    \draw[-{Stealth[length=3mm]}, thick, blue] (x1) to[out=8, in=140] node[midway, above]  {$J_{\varphi_{\theta}}$} (xJ0);  
    \draw[-{Stealth[length=3mm]}, thick, green!80!black] (xJ01) to[out=170, in=10] node[midway, below] {$\psi_{\theta}$} (xJ11);  
    \draw[-{Stealth[length=3mm]}, thick, blue] (x11) to[out=-8, in=-170] node[midway, below]  {$J_{\varphi_{\theta}}$} (xJ01);
...
\draw[red, <->, dashed] (x1) to node[midway, left] {$d$} (xJ1);
\draw[red, <->, dashed] (x11) to node[midway, below] {$d'$} (xJ11);
